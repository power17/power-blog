import{_ as a,o as e,c as l,k as s,t as p,a as o,Q as c}from"./chunks/framework.2ddacb3d.js";const q=JSON.parse('{"title":"数组","description":"与 Java 、PHP 等语言不同，在 JavaScript 中，数组其实是一种特殊的对象","frontmatter":{"title":"数组","author":"power","description":"与 Java 、PHP 等语言不同，在 JavaScript 中，数组其实是一种特殊的对象","date":"2023-09-21T09:52:51.000Z","link":"./algorithm/Array","tags":["数据结构"]},"headers":[],"relativePath":"algorithm/Array.md","filePath":"algorithm/Array.md","lastUpdated":1695268819000}'),t={name:"algorithm/Array.md"},r=s("h2",{id:"数组",tabindex:"-1"},[o("数组 "),s("a",{class:"header-anchor",href:"#数组","aria-label":'Permalink to "数组"'},"​")],-1),i=c(`<h4 id="数组的创建与读写" tabindex="-1">数组的创建与读写 <a class="header-anchor" href="#数组的创建与读写" aria-label="Permalink to &quot;数组的创建与读写&quot;">​</a></h4><p>以下两种方式都可创建数组：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 字面量方式,常用</span></span>
