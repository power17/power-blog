import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.e245370a.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/LinkedList.md","filePath":"algorithm/LinkedList.md","lastUpdated":1695197264000}'),p={name:"algorithm/LinkedList.md"},o=l(`<ul><li>链表</li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/**</span></span>
...
<span class="line"><span style="color:#6A737D;">// const lastElement = LList.findByIndex(3);</span></span>
<span class="line"><span style="color:#6A737D;">// lastElement.next = LList.head;</span></span>
<span class="line"><span style="color:#6A737D;">// console.log(LList.checkCircle(), lastElement);</span></span></code></pre></div>`,2),e=[o];function c(t,r,E,y,i,F){return n(),a("div",null,e)}const D=s(p,[["render",c]]);export{A as __pageData,D as default};
