import{_ as l,o as p,c as o,k as s,a as e,t as n,Q as c}from"./chunks/framework.cb9cb047.js";const b=JSON.parse('{"title":"mysql基本操作","description":"首先声明mysql的版本是：8.0.33，系统操作是mac Monteron 12.3。内容是数据库的基本命令","frontmatter":{"title":"mysql基本操作","author":"power","description":"首先声明mysql的版本是：8.0.33，系统操作是mac Monteron 12.3。内容是数据库的基本命令","date":"2023-09-22T12:42:44.000Z","link":"./databases/Mysql","tags":["数据结构"]},"headers":[],"relativePath":"databases/Mysql.md","filePath":"databases/Mysql.md","lastUpdated":1695360334000}'),t={name:"databases/Mysql.md"},r={id:"frontmatter-title",tabindex:"-1"},y=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),i=c(`<h3 id="数据库的连接" tabindex="-1">数据库的连接 <a class="header-anchor" href="#数据库的连接" aria-label="Permalink to &quot;数据库的连接&quot;">​</a></h3><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">mysql</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">--version</span></span>
