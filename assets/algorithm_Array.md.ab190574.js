import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.a142706d.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithm/Array.md","filePath":"algorithm/Array.md","lastUpdated":1695197264000}'),l={name:"algorithm/Array.md"},p=e(`<p>与 Java 、PHP 等语言不同，在 JavaScript 中，数组其实是一种特殊的对象。</p><h4 id="数组的创建与读写" tabindex="-1">数组的创建与读写 <a class="header-anchor" href="#数组的创建与读写" aria-label="Permalink to &quot;数组的创建与读写&quot;">​</a></h4><p>以下两种方式都可创建数组：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">// 字面量方式,常用</span></span>
